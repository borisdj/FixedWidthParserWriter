...
Library (C# .NET) for Parsing(Reading) & Writing fixed-width/flat data files (.txt or other), very Efficient - [NoReflection](https://github.com/mgravell/fast-member).<br>
