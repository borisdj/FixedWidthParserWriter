...
Library (C# .NET) for Parsing(Reading) & Writing fixed-width/flat data files (.txt, others). Uses [FastMember](https://github.com/mgravell/fast-member) No Reflection.<br>
