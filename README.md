...
Library (C# .NET) for Parsing(Reading) & Writing fixed-width/flat data files (.txt or other). Uses [FastMember](https://github.com/mgravell/fast-member) instead of Reflection.<br>
