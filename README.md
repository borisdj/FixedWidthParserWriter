...
Library (C# .NET) for Parsing(Reading) & Writing fixed-width/flat data files (.txt, others). Uses [FastMember](https://github.com/mgravell/fast-member) No slow Reflection.<br>
It is targeting NetStandard 2.0 so it can be used on project targeting NetCore(2.0+) or NetFramework(4.6.1+).

Available on [![NuGet](https://img.shields.io/nuget/vpre/FixedWidthParserWriter.svg)](https://www.nuget.org/packages/FixedWidthParserWriter/) latest version.<br>
