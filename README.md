...
Library (C# .NET) for Parsing(Reading) & Writing fixed-width/flat data files (.txt or other).Efficient [FastMember](https://github.com/mgravell/fast-member) No Reflection.<br>
